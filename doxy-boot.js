$( document ).ready(function() {
    ...
    $('li > a[href="index.html"] > span').before("<i class='fa fa-home fa-lg'></i> ");
    $('li > a[href="modules.html"] > span').before("<i class='fa fa-codepen fa-lg'></i> ");
    $('li > a[href="files.html"] > span').before("<i class='fa fa-file-code-o fa-lg'></i> ");
    $('li > a[href="annotated.html"] > span').before("<i class='fa fa-database fa-lg'></i> ");
